...
--
-- This module can be loaded with `local ui = require("cosmic.utils.ui")`
--
-- @module cosmic.utils.ui
-- @see cosmic.utils
-- @copyright 2022
...
local function ui_notify(str)
  if vim.g.ui_notifications_enabled then require("cosmic.utils").notify(str) end
end
...
function M.toggle_diagnostics()
  ...
  vim.diagnostic.config(require("cosmic.utils.lsp").diagnostics[vim.g.diagnostics_mode])
...
function M.toggle_url_match()
  ...
  require("cosmic.utils").set_url_match()
end
