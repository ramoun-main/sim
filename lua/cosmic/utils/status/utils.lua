--- ### Cosmic Status Utilities
--
-- Statusline related uitility functions
--
-- This module can be loaded with `local status_utils = require "cosmic.utils.status.utils"`
--
-- @module cosmic.utils.status.utils
-- @copyright 2023
...
-- @usage local string = require("cosmic.utils.status").utils.stylize("Hello", { padding = { left = 1, right = 1 }, icon = { kind = "String" } })
...
-- @usage local heirline_component = { on_click = { callback = function(...) local args = require("cosmic.utils.status").utils.statuscolumn_clickargs(...) end } }
