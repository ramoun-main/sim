--- ### Cosmic Status Heirline Extensions
--
-- Statusline related heirline specific extensions
--
-- This module can be loaded with `local astro_heirline = require "cosmic.utils.status.heirline"`
--
-- @module cosmic.utils.status.heirline
-- @copyright 2023
