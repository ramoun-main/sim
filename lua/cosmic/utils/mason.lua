--- ### Mason Utils
--
-- Mason related utility functions to use within Cosmic and user configurations.
--
-- This module can be loaded with `local mason_utils = require("cosmic.utils.mason")`
--
-- @module cosmic.utils.mason
-- @see cosmic.utils
-- @copyright 2022
