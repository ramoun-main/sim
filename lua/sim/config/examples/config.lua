-- Override Sim configuration options
...
local config = {
  ...
  lsp = {
    ...
    servers = {
      ...
      -- See Sim defaults lsp/providers/null_ls.lua and https://github.com/jose-elias-alvarez/null-ls.nvim/
      ...
      null_ls = {
        -- Disable default list of sources provided by Sim
    ...
    -- See Sim defaults lua/plugins/nvim-lsp-ts-utils/setup.lua
    ts_utils = {},
  },
