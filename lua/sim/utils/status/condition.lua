--- ### Cosmic Status Conditions
--
-- Statusline related condition functions to use with Heirline
--
-- This module can be loaded with `local condition = require "cosmic.utils.status.condition"`
--
-- @module cosmic.utils.status.condition
-- @copyright 2023
...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("cosmic.utils.status").condition.is_active }
...
-- @usage local heirline_component = { provider = "Example Provider", condition = function() return require("cosmic.utils.status").condition.buffer_matches { buftype = { "terminal" } } end }
...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("cosmic.utils.status").condition.is_macro_recording }
...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("cosmic.utils.status").condition.is_hlsearch }
...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("cosmic.utils.status").condition.is_statusline_showcmd }
...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("cosmic.utils.status").condition.is_git_repo }
...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("cosmic.utils.status").condition.git_changed }
...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("cosmic.utils.status").condition.file_modified }
...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("cosmic.utils.status").condition.file_read_only }
...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("cosmic.utils.status").condition.has_diagnostics }
...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("cosmic.utils.status").condition.has_filetype }
...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("cosmic.utils.status").condition.aerial_available }
...
---@param bufnr table|integer a buffer number to check the condition for, a table with bufnr property, or nil to get the current buffer
---@return boolean # whether or not LSP is attached
-- @usage local heirline_component = { provider = "Example Provider", condition = require("cosmic.utils.status").condition.lsp_attached }
...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("cosmic.utils.status").condition.treesitter_available }
