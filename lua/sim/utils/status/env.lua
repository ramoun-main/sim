--- ### Cosmic Status Environment
--
-- Statusline related environment variables shared between components/providers/etc.
--
-- This module can be loaded with `local env = require "cosmic.utils.status.env"`
--
-- @module cosmic.utils.status.env
-- @copyright 2023
...
M.separators = cosmic.user_opts("heirline.separators", {
  none = { "", "" },
  left = { "", "  " },
  right = { "  ", "" },
  center = { "  ", "  " },
...
M.attributes = cosmic.user_opts("heirline.attributes", {
...
M.icon_highlights = cosmic.user_opts("heirline.icon_highlights", {
  file_icon = {
...
M.sign_handlers = cosmic.user_opts("heirline.sign_handlers", M.sign_handlers)
