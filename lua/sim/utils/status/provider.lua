--- ### Cosmic Status Providers
--
-- Statusline related provider functions for building statusline components
--
-- This module can be loaded with `local provider = require "cosmic.utils.status.provider"`
--
-- @module cosmic.utils.status.provider
-- @copyright 2023
...
-- @usage local heirline_component = { provider = require("cosmic.utils.status").provider.fill }
...
-- @usage local heirline_component = { provider = require("cosmic.utils.status").provider.signcolumn }
-- @see cosmic.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("cosmic.utils.status").provider.numbercolumn }
-- @see cosmic.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("cosmic.utils.status").provider.foldcolumn }
-- @see cosmic.utils.status.utils.stylize
function M.foldcolumn(opts)
  opts = extend_tbl({ escape = false }, opts)
  local ffi = require "cosmic.utils.ffi" -- get Cosmic C extensions
...
-- @usage local heirline_component = { provider = require("cosmic.utils.status").provider.tabnr() }
function M.tabnr()
...
-- @usage local heirline_component = { provider = require("cosmic.utils.status").provider.spell() }
-- @see cosmic.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("cosmic.utils.status").provider.paste() }
-- @see cosmic.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("cosmic.utils.status").provider.macro_recording() }
-- @see cosmic.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("cosmic.utils.status").provider.showcmd() }
-- @see cosmic.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("cosmic.utils.status").provider.search_count() }
-- @see cosmic.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("cosmic.utils.status").provider.mode_text() }
-- @see cosmic.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("cosmic.utils.status").provider.percentage() }
-- @see cosmic.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("cosmic.utils.status").provider.ruler({ pad_ruler = { line = 3, char = 2 } }) }
-- @see cosmic.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("cosmic.utils.status").provider.scrollbar() }
-- @see cosmic.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("cosmic.utils.status").provider.close_button() }
-- @see cosmic.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("cosmic.utils.status").provider.filetype() }
-- @see cosmic.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("cosmic.utils.status").provider.filename() }
-- @see cosmic.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("cosmic.utils.status").provider.file_encoding() }
-- @see cosmic.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("cosmic.utils.status").provider.file_format() }
-- @see cosmic.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("cosmic.utils.status").provider.unique_path() }
-- @see cosmic.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("cosmic.utils.status").provider.file_modified() }
-- @see cosmic.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("cosmic.utils.status").provider.file_read_only() }
-- @see cosmic.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("cosmic.utils.status").provider.file_icon() }
-- @see cosmic.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("cosmic.utils.status").provider.git_branch() }
-- @see cosmic.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("cosmic.utils.status").provider.git_diff({ type = "added" }) }
-- @see cosmic.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("cosmic.utils.status").provider.diagnostics({ severity = "ERROR" }) }
-- @see cosmic.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("cosmic.utils.status").provider.lsp_progress() }
-- @see cosmic.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("cosmic.utils.status").provider.lsp_client_names({ expand_null_ls = true, truncate = 0.25 }) }
-- @see cosmic.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("cosmic.utils.status").provider.treesitter_status() }
-- @see cosmic.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("cosmic.utils.status").provider.str({ str = "Hello" }) }
-- @see cosmic.utils.status.utils.stylize
function M.str(opts)
